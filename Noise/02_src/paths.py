def returnp(key):
    p = {}
/Users/theresasawi/Documents/12_Projects/SawiEtAl_2022/Noise/02_src/paths.py
    ...
    path_top        = "/Users/theresasawi/Documents/12_Projects/SawiEtAl_2022/"
    path_proj       = path_top+projName+'/'
    outfile_name    = 'SpecUFEx_out_' + projName + '_all.hdf5'
    dataFile_name   = f'{projName}_data.hdf5'
    subCatalog_Name = f'{key}_Sgrams_Subcatalog.hdf5'
