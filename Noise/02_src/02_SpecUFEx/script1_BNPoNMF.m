...
dim = 323%161%174%173%266;%10000%299;%94%299 ; % 513; %308; % 308 is the length of f-vector if cut above 150 Hz (originates from the Geysers study, where there was too much noise above 150 Hz)
